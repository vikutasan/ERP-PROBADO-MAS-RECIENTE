...
export const ProductionManagementUI = () => {
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-black/40 backdrop-blur-md animate-in fade-in duration-500 p-8 pt-6">
            
            {/* Cabecera (Subida al tope) */}
            <div className="mb-12">
                ...
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[1em] mt-2">
