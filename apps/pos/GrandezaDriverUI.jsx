                    ...
                    <div className="p-4 space-y-2">
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4">
                            ...
                            <div className="mt-3 flex flex-col gap-2">
                                ...
                                <button onClick={sendWhatsApp} className="w-full py-3 bg-[#25D366] rounded-xl text-xs font-black text-white uppercase active:scale-95 transition-all flex justify-center items-center gap-2 mt-2 shadow-[0_0_15px_rgba(37,211,102,0.3)] border border-[#1ea852]">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-5 h-5" style={{ width: '20px', height: '20px' }}>
